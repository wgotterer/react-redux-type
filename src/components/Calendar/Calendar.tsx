...
// we can wrap our functional component with the connector which turns it into
// a higher order function and allows acces to through props to the mapState and mapDispatch
